 ...
 */
public class V_JDialog_EditarMarca extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(V_JDialog_EditarMarca.class.getName());

    /**
     * Creates new form V_JDialog_EditarMarca
     */
    public V_JDialog_EditarMarca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                V_JDialog_EditarMarca dialog = new V_JDialog_EditarMarca(new javax.swing.JFrame(), true);
